  ...
  return (
    ...
    >
      ...
      <box flexDirection="column" paddingTop={1}>
        ...
        <DetailRow label="Exit Status" value={service.exitStatus} color={service.exitStatus !== 0 ? '#ef4444' : undefined} />
        <DetailRow label="Enabled" value={service.enabled ? 'Yes' : 'No'} color={service.enabled ? '#22c55e' : '#ef4444'} />
        <DetailRow label="Plist Path" value={service.plistPath} />
        <DetailRow label="Description" value={service.description} />
        {service.lastError && (
          <DetailRow label="Last Error" value={service.lastError} color="#ef4444" />
        )}
