...
import type { ServiceType, ServiceDomain, ServiceStatus } from '../types';
  ...
  return (
    ...
    >
      ...
      <box flexDirection="row" gap={1} alignItems="center">
        <text fg="#6b7280" width={8}>Type:</text>
      ...
      {/* Domain filter */}
      <box flexDirection="row" gap={1} alignItems="center">
        <text fg="#6b7280" width={8}>Domain:</text>
        <box flexDirection="row" gap={1}>
      ...
      {/* Status filter */}
      <box flexDirection="row" gap={1} alignItems="center">
        <text fg="#6b7280" width={8}>Status:</text>
        <box flexDirection="row" gap={1}>
      ...
      <box flexDirection="row" gap={2} alignItems="center">
        <text fg="#6b7280" width={8}>Show:</text>
      ...
      {/* Sort info */}
      <box flexDirection="row" gap={1} alignItems="center">
        <text fg="#6b7280" width={8}>Sort:</text>
        <text fg="#9ca3af">
